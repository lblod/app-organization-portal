defmodule Dispatcher do
  ...
  match "/additional-qualification-codes/*path", %{accept: [:json], layer: :api} do
    Proxy.forward(conn, path, "http://cache/additional-qualification-codes/")
  end
  ...
  match "/worship/person-information-updates/*path", %{
    layer: :api_services,
    accept: %{json: true}
  } do
  ...
  match "/worship/person-information-requests/*path", %{
    layer: :api_services,
    accept: %{json: true}
  } do
  ...
  match "/worship/person-information-validate-ssn/*path", %{
    layer: :api_services,
    accept: %{json: true}
  } do
  ...
  post "/construct-organization-relationships/*path", %{
    layer: :api_services,
    accept: %{json: true}
  } do
